...
if ($currenttab == 'reports' and isset($type)) {
    ...
    $url = "$CFG->wwwroot/mod/threesixty/report.php?a=$threesixty->id{$useridparam}";
...
if ($currenttab == 'edit' and isset($section)) {
    ...
    $row[] = new tabobject('carryover', "$CFG->wwwroot/mod/threesixty/carryover.php?a=$threesixty->id{$useridparam}",
