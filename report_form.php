...
class mod_threesity_report_form extends moodleform {
    ...
    function definition() {
        ...
        $belowaveragestr = get_string('belowaverage', 'threesixty');
        $aboveaveragestr = get_string('aboveaverage', 'threesixty');
        ...
        if($type == 'spiderweb') {
        	...
        	// key for tables
        	$mform->addElement('html', "<span class='scoresmaller'>&nbsp; &nbsp;</span> $belowaveragestr&nbsp; &nbsp;<span class='scorebigger'>&nbsp; &nbsp;</span> $aboveaveragestr ");
    	}
    }
}
